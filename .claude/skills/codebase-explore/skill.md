...
description: Read-only exploration of unfamiliar codebase areas — maps key files, traces data flow, and summarizes dependencies. Use when the user asks to explore, investigate, or understand how something works.
---
